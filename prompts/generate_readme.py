...
prompt = PromptTemplate(
    input_variables=['document_url'],
    template="""You are an Expert Technical writer.
    You are assigned the task of writing a User guide for the given product.

    You will get the product URL from user. 
    your task is to generate README.md in Markdown format.
